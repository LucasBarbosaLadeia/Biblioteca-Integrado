  ...
  return (
    <View style={styles.cardContainer}>
      <CustomAlert
        ...
        title="Aviso"
        message={
          "Funcionalidade ser├í implementada quando houver integra├º├úo com o lado da empresa."
        }
      ...
      {book.isAvailable ? (
        <>
          ...
          <Text style={styles.detailText}>
            Exemplares Dispon├¡veis: {book.qt_atual}
          </Text>
          <Text style={styles.detailText}>
            Localiza├º├úo: Prateleira {book.prateleira}
          </Text>
        </>
      ) : (
        <>
...
const styles = StyleSheet.create({
  ...
  detailText: { color: "white", fontSize: 16, marginTop: 5 }, // Adicionei um marginTop para espa├ºamento
  notifyButton: {
    borderWidth: 1,
    borderColor: "white",
    borderRadius: 20,
