      ...
      <SafeAreaView className="flex-1">
        ...
        >
          ...
          <CustomAlert
            ...
            buttonText={"OK"}
          />
          <Text className="text-3xl md:text-4xl font-bold text-gray-200 mb-12">
            Biblioteca Integrado
          </Text>

          <View className="w-11/12 md:w-2/3 lg:w-1/3">
            <TextInput
            ...
            <View className="flex-row items-center bg-white rounded-lg h-12 px-1 mb-4">
              <TextInput
